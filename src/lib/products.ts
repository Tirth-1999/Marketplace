...
export const products: Product[] = [
  ...
  {
    id: "gautam-graduation-regalia",
    title: "Texas A&M Graduation Gown Set",
    price: 90,
    description:
      "Texas A&M / ATM graduation regalia — black gown with maroon ATM cuffs, academic hood, and mortarboard with tassel. Listed by Gautam M.",
    specs: [
      "Texas A&M / ATM regalia",
      "Includes gown, hood, and mortarboard",
      "Price: $90 — negotiable",
    ],
    category: "Graduation",
    negotiable: true,
    ...
    galleryAspect: "portrait",
    images: [
      "/products/gautam-graduation-regalia/gautam-graduation-regalia-01.jpeg",
      "/products/gautam-graduation-regalia/gautam-graduation-regalia-02.jpeg",
    ],
  },
  {
  ...
  },
  {
    ...
    price: 20,
    description:
      "The Heart Supply skateboard with colorful deck graphic plus Schwinn white/teal skate helmet (visor included). Board has grip tape, silver trucks, and used wheels. Listed by Gautam M.",
    specs: [
      "Brand: The Heart Supply (skateboard)",
      "Helmet: Schwinn — white/teal with detachable visor",
      "Includes skateboard + helmet",
      "Price: $20 — negotiable",
    ],
    category: "Transport",
    negotiable: true,
    ...
    galleryAspect: "square",
    images: [
      "/products/skateboard-helmet/skateboard-helmet-01.png",
      "/products/skateboard-helmet/skateboard-helmet-02.png",
      "/products/skateboard-helmet/skateboard-helmet-03.png",
      "/products/skateboard-helmet/skateboard-helmet-04.png",
    ],
  },
  {
    id: "office-chair-striped",
    title: "Black Office Chair (Striped)",
    price: 35,
    description:
      "Black faux-leather office chair with horizontal striped stitching on the backrest and seat, padded armrests, and a five-star caster base. Listed by Gautam M.",
    specs: [
      "Faux-leather / vinyl upholstery",
      "Horizontal striped stitching",
      "Rolling caster base with armrests",
      "Price: $35 — negotiable",
    ],
    category: "Furniture",
    negotiable: true,
    seller: SELLERS.gautam,
    galleryAspect: "portrait",
    images: ["/products/office-chair-striped/office-chair-striped-01.png"],
  },
  {
    id: "office-chair-basic",
    title: "Black Office Chair",
    price: 10,
    priceNote: "Non-negotiable",
    description:
      "Black faux-leather office chair with contoured (non-straight) seam stitching, padded armrests, and swivel caster base. Some wear on the backrest upholstery. Listed by Gautam M.",
    specs: [
      "Faux-leather / vinyl upholstery",
      "Contoured seam stitching",
      "Some wear on backrest",
      "Price: $10 (firm / non-negotiable)",
    ],
    category: "Furniture",
    negotiable: false,
    seller: SELLERS.gautam,
    galleryAspect: "portrait",
    images: ["/products/office-chair-basic/office-chair-basic-01.png"],
  },
  {
    id: "monitor-damaged",
    title: "Computer Monitor (Damaged Screen)",
    price: 5,
    priceNote: "Non-negotiable",
    description:
      "Flat-screen computer monitor with silver stand. Screen has a vertical black line down the center (damage). Sold as-is for parts or secondary use. Listed by Gautam M.",
    specs: [
      "Vertical black line damage on screen",
      "Sold as-is",
      "Price: $5 (non-negotiable)",
    ],
    category: "Electronics",
